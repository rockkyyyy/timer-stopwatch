let instructionsActive = document.getElementById("instruction-activate"),
  setTimerVal = document.getElementById("setTime"),
...
instructionsActive.addEventListener("click", async () => {
  let wrapperClass = document.querySelector(".wrapper"),
    buttonsClass = document.querySelector(".buttons"),
    textClass = document.querySelector(".text");
  textClass.classList.toggle("instructions-active");
  await sleep(150);
  wrapperClass.classList.toggle("slide-active");
  buttonsClass.classList.toggle("slide-active");
});
